...
interface PremiumAgentHeaderProps {
  agent: any;
  kpiCards: KPICard[];
  onNewClient: () => void;
  onNewSale: () => void;
...
export function PremiumAgentHeader({
  agent,
  kpiCards,
  onNewClient,
  onNewSale,
}: PremiumAgentHeaderProps) {
            ...
            {kpiCards.map((kpi, idx) => (
              <motion.div key={idx} variants={itemVariants}>
                ...
                >
                  ...
                  {/* Card */}
                  <div className="relative bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
